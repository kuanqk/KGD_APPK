...
- **Заслушивание** — назначение, протокол, крайний срок замечаний к протоколу **3 рабочих дня** (п. 6 ст. 74 АППК; напоминания Celery)
...
| `reviewer` | Все офисы | Да | Да | Да | Сводка по офисам |
